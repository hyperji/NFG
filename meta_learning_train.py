...
from meta_learning import Prototypical_Nets, NFG_Prototypical_Nets, CNN_TPN
...
if __name__ == "__main__":
    ...
    if arg.dataset == "mini-ImageNet":
        ...
        test_generator1 = MiniImageNet_Generator(
            X_test, n_way=n_way_test, n_shot=5, n_query=n_query_test)
    ...
    for episode in range(arg.n_test_episodes):
        ...
        #print("test acc", acc)
        accs.append(acc)
    print("final mean acc shot 5", np.mean(accs))
    ...
    for episode in range(arg.n_test_episodes):
        ...
        # print("test acc", acc)
        accs.append(acc)
    print("final mean acc shot 1", np.mean(accs))
